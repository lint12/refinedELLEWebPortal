...
import { Input, Label, Row, Col, Table, Card, Alert, InputGroup, InputGroupAddon } from 'reactstrap';
...
class AddExistingModule extends React.Component {
  ...
  getAllModulesInDB = () => {
    ...
    .then(res => {
        console.log("ALL MODULES IN DB: ", res.data); 
  ...
  add = (e) => {
    ...
    console.log("ADD EXISTING MODULE DATA: ", data); 
    ...
    .then(res => {
      console.log("submit Existing Module res.data: ", res.data);
